#CAPSTONE PROJECT Programming Interview Prep App

##Name of Student: Austin Roberts

##Name of Project: Programming Interview App##

##Project’s Purpose or Goal: Display a practice questions for a programming interview##

##List the absolute minimum features the project requires to meet this purpose or goal:##

* 1.) Choose language to practice
* 2.) User sees a programming question and it's desired functionality
* 3.) User types a solution into an input box where it is checked for syntax.
* 4.) User is notified if their solution is correct.
* 5.) User has the option to skip or go back to home
* 6.) User can view the solution with a button
